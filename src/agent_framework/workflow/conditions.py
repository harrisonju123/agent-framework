...
class PreviewApprovedCondition(ConditionEvaluator):
    """True if the architect approved an execution preview for implementation.

    Checks verdict == "preview_approved" from task context. The architect sets
    this after reviewing the engineer's preview output and authorizing the write.
    """
