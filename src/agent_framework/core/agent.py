...
# Review cycle constants and dataclasses moved to review_cycle.py
...
class Agent:
    ...
    def __init__(
        ...
        # Review cycle management: QA review & fix loop
...
"""
    ...
    # -- Delegated review cycle methods (implemented in ReviewCycleManager) --

    def _extract_pr_info_from_response(self, response_content: str) -> Optional[Dict[str, Any]]:
        """Delegate to ReviewCycleManager."""
    ...
    def _queue_review_fix_if_needed(self, task: Task, response) -> None:
        """Delegate to ReviewCycleManager."""
        return self._review_cycle.queue_review_fix_if_needed(task, response, sync_jira_fn=self._sync_jira_status)
...
# Ensure existing imports like "from agent_framework.core.agent import QAFinding, ReviewOutcome" continue to work
__all__ = ["Agent", "AgentConfig", "QAFinding", "ReviewOutcome"]
